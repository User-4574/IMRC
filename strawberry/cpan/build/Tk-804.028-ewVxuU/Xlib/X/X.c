 ...
 * contents of X.xs. Do not edit this file, edit X.xs instead.
 *
...
XS(XS_Tk__X_constant); /* prototype to pass -Wmissing-prototypes */
XS(XS_Tk__X_constant)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Tk::X::constant", "name, arg");
...
extern "C"
#endif
XS(boot_Tk__X); /* prototype to pass -Wmissing-prototypes */
XS(boot_Tk__X)
{
#ifdef dVAR
    dVAR; dXSARGS;
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        newXSproto("Tk::X::constant", XS_Tk__X_constant, file, "$$");
    XSRETURN_YES;
}
