...
static Tk_ConfigSpec configSpecs[] = {
    {TK_CONFIG_STRING, "-data",          NULL,          NULL,
	         NULL, Tk_Offset(PixmapMaster, dataString), TK_CONFIG_NULL_OK},
    {TK_CONFIG_STRING, "-file",          NULL,          NULL,
	         NULL, Tk_Offset(PixmapMaster, fileString), TK_CONFIG_NULL_OK},
    {TK_CONFIG_UID, "-id",          NULL,          NULL,
	         NULL, Tk_Offset(PixmapMaster, id), TK_CONFIG_NULL_OK},
    ...
    PixmapMaster *masterPtr;
{
	...
	Tcl_Panic("ImgXpmGetData(): -data, -file, -array and -id are all NULL");
    }
...
static int
ImgXpmCmd(clientData, interp, argc, objv)
    ...
    Tcl_Obj *CONST *objv;		/* Argument strings. */
{
	...
	if (argc == 2) {
	    ...
	    code = ImgXpmConfigureMaster(masterPtr, argc-2, objv+2,
		    TK_CONFIG_ARGV_ONLY);
	}
	return code;
	...
	Tcl_AppendResult(interp, "bad option \"", Tcl_GetString(objv[1]),
	    "\": must be cget, configure or refcount",          NULL);
	return TCL_ERROR;
    }
}
